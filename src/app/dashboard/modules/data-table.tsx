...
import DeleteSelectedModules from './delete-selected-modules'
import AddModuleForm from './form-module-create'
    ...
    <>
      <div className="flex justify-between items-center py-4">
        ...
        <div className="flex gap-2">
          {/* Search Box - to filter records by module ID */}
          <Input
            placeholder="Search by module ID..."
            defaultValue={
              (table.getColumn('moduleId')?.getFilterValue() as string) ?? ''
            }
            onChange={(event) =>
              table.getColumn('moduleId')?.setFilterValue(event.target.value)
            }
        ...
        <div className="flex gap-2">
          ...
          <DeleteSelectedModules table={table} />
