...
import DeleteSelectedStudents from "@/components/dashboard/professor/delete-selected-records";
import AddProfessorForm from "@/components/dashboard/professor/form-professor-create";
