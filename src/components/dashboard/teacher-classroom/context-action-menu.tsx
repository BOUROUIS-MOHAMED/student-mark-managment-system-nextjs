...
export default function ContextActionMenu({ teacherClassroom }: { teacherClassroom: TeacherClassroom }) {
      ...
      <DropdownMenuContent align="end">
        ...
        <DropdownMenuItem
          ...
          onClick={() =>
            ...
            navigator.clipboard.writeText(teacherClassroom.id.toString())
          }
        >
