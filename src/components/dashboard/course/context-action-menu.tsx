...
import EditCourseForm from "@/components/dashboard/course/form-course-edit";
import DeleteCourse from "@/components/dashboard/course/form-course-delete";
import {usePathname} from "next/navigation";




export default function ContextActionMenu({ course }: { course: Course }) {
    ...
    <DropdownMenu open={openDropdown} onOpenChange={setOpenDropdown}>
      ...
      <DropdownMenuContent align="end">
        ...
        <DropdownMenuItem asChild>
          <Link href={`${pathname}/${course.id}`} className="flex cursor-pointer">
